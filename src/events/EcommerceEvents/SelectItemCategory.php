...
class SelectItemCategory extends WebEvent
{
    ...
    public function __construct(string $category_name,string $category_id,?string $browser_agent = null,
    ...
    {
        $this->extracted($category_name,$this,$category_id,$sub_category_name,$sub_category_id,$tags,$userId,$sessionId,$browser_agent,$ip_address);
